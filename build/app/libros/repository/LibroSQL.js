...
exports.SQL_LIBRO = void 0;
exports.SQL_LIBRO = {
    GET_ALL: "SELECT * FROM Libros",
    HOW_MANY: "SELECT COUNT(*) AS existe FROM Libros WHERE id_autor = $1",
    HOW_MANY_NAME: "SELECT COUNT(*) AS existe FROM Libros WHERE titulo_libro = $1",
