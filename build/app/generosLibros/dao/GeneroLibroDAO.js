...
const GeneroLibroSQL_1 = require("../repository/GeneroLibroSQL");
...
class GeneroLibroDAO {
    static obtenerTodo(params, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield db_conection_1.default.result(GeneroLibroSQL_1.SQL_GENEROLIBRO.GELL_ALL, params)
                .then((resultado) => {
...
exports.default = GeneroLibroDAO;
